...
public class FilterParamsTests
{
  ...
  {
    params1 = new FilterParams("keyword", 1, 5, 10, "id", "ASC");
    assertThat(params1).isNotNull();
  }
  ...
  {
    params1 = FilterParams.builder().keyword("keyword").filter(1).page(5).limit(10).sortBy("id").sortDir("ASC").build();
    assertThat(params1).isNotNull();
    confirmIntegrity(params1);
  }
  ...
  {
    params1 = new FilterParams("keyword", 1, 5, 10, "id", "ASC");
    params2 = new FilterParams("keyword", 1, 5, 10, "id", "ASC");
    params3 = new FilterParams("wordkey", 0, 0, 5, "id", "DESC");
  ...
  private void confirmIntegrity(FilterParams param) {
    ...
    assertThat(param.getFilter()).isEqualTo(1);
