...
public class AccountHolderTest
{
	...
	{
		accountHolder1 = new AccountHolder(userId, fullName, dob, ssn, address, city, state, zip, phone, null, null,null);
		assertThat(accountHolder1).isNotNull();
	}
	...
	void test_CanCompareWithEquals()
	{
		...
		accountHolder1 = new AccountHolder(userId, fullName, dob, ssn, address, city, state, zip, phone, null, null,null);
		accountHolder2 = new AccountHolder(2, fullName, dob, "234-56-7890", address, city, state, zip, phone, null, null,null);
		accountHolder3 = new AccountHolder(userId, fullName, dob, ssn, address, city, state, zip, phone, null, null,null);
