...
import static org.ssor.boss.core.entity.LoanType.LOAN_UNKNOWN;
...
public class LoanRepositoryTest
{
  ...
  public void test_CanFindByUserId()
  {
    ...
    List<Loan> results = loanRepository.findAllByUserIdAndLoanNumberStartsWithAndLoanTypeIs(1, "", LOAN_UNKNOWN, page)
                                       .getContent();
  ...
  {
    Pageable page = PageRequest.of(0, 2);
    List<Loan> results = loanRepository.findAllByBranchIdAndLoanNumberStartsWithAndLoanTypeIs(1, "", LOAN_UNKNOWN, page)
                                       .getContent();
    assertThat(results).isNotNull().isNotEmpty();
    Loan result = results.get(0);
    assertThat(result.getId()).isNotNull().isEqualTo(1);
